...
from .views import AddFundsToWallet, GetProductByIdView, GetProductsByCategoryView, OrderHistoryView, RegisterView, AddProductView, GetProductsView, AddToCartView,BuyCartView,GetOrderHistory, SalesReportByBrand, SalesReportByDateRange, WalletDetails
...
urlpatterns = [
    ...
    path('products-by-category/', GetProductsByCategoryView.as_view(), name='get_products_by_category'),
